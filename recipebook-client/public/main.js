...
var AddRecipeComponent = /** @class */ (function () {
    ...
    AddRecipeComponent.prototype.onSubmit = function (value) {
        var _this = this;
        this.recipeService.addRecipe(value)
            .subscribe(function (data) { return _this.recipes.push(data); }, function (error) { return _this.errorMsg = error; });
    };
...
/* harmony import */ var _add_recipe_add_recipe_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add-recipe/add-recipe.component */ "./src/app/add-recipe/add-recipe.component.ts");
...
var routes = [
    ...
    { path: 'recipes', component: _recipe_list_recipe_list_component__WEBPACK_IMPORTED_MODULE_5__["RecipeListComponent"] },
    { path: 'recipe', component: _add_recipe_add_recipe_component__WEBPACK_IMPORTED_MODULE_2__["AddRecipeComponent"] },
...
var routingComponents = [
    ...
    _add_recipe_add_recipe_component__WEBPACK_IMPORTED_MODULE_2__["AddRecipeComponent"]
];
...
module.exports = "<section class=\"jumbotron text-center\">\n  <div class=\"fluid-container col-md-4\">\n  </div>\n  <div class=\"container\">\n    <h1 class=\"jumbotron-heading \">RecipeBook</h1>\n    <p class=\"lead text-muted\">This is the application with a collection of delicious recipes.</p>\n    <p>\n      <button routerLink=\"/recipe\" routerLinkActive=\"active\" type=\"button\" class=\"btn btn-success\" data-toggle=\"modal\" data-target=\"#exampleModal\">\n        Add Recipe\n      </button>\n    </p>\n  </div>\n</section>"
...
module.exports = "<div class=\"search\">\r\n\t<input #query (keyup)=\"search(query.value)\" class=\"form-control col-md-4 mr-sm-1 border border-info\" type=\"text\" placeholder=\"Search...\" aria-label=\"Search\">\r\n</div>\r\n<div class=\"album py-5 bg-light\">\r\n\t<div class=\"container\">\r\n\t\t<div class=\"row\">\r\n\t\t\t<div class=\"col-md-4\" *ngFor=\"let recipe of searchRecipes\">\r\n\t\t\t\t<div class=\"card mb-4 box-shadow\">\r\n\t\t\t\t\t<img class=\"card-img-top\" src=\"../../assets/img/pizza.jpg\" alt=\"Card image cap\">\r\n\t\t\t\t\t<div class=\"card-body\">\r\n\t\t\t\t\t\t<p class=\"card-text\">Name: {{recipe.name}}</p>\r\n\t\t\t\t\t\t<p class=\"card-text\">Description: {{recipe.description}}</p>\r\n\t\t\t\t\t\t<p class=\"card-text\">Ingredients: {{recipe.ingredients}}</p>\r\n\t\t\t\t\t\t<div class=\"d-flex justify-content-between align-items-center\">\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n</div>\r\n"
...
var RecipeListComponent = /** @class */ (function () {
    function RecipeListComponent(router, route, recipeService) {
        this.router = router;
        this.route = route;
        this.recipeService = recipeService;
        this.recipes = [];
    ...
    RecipeListComponent.prototype.ngOnInit = function () {
        ...
        this.recipeService.getRecipes()
            .subscribe(function (data) { return _this.searchRecipes = _this.recipes = data; }, function (error) { return _this.errorMsg = error; });
    };
    RecipeListComponent.prototype.search = function (query) {
        this.searchRecipes = (query) ? this.recipes.filter(function (recipe) { return recipe.name.toLowerCase().includes(query.toLowerCase()); }) : this.recipes;
    };
...
var RecipeService = /** @class */ (function () {
    function RecipeService(http) {
        this.http = http;
        this.getUrl = 'api/recipes';
        this.postUrl = 'api/recipe';
    }
    RecipeService.prototype.errorHandler = function (error) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(error.message || 'Server Error');
    };
    RecipeService.prototype.getRecipes = function () {
        return this.http.get(this.getUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler));
    };
    RecipeService.prototype.addRecipe = function (recipe) {
        return this.http.post(this.postUrl, recipe, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler));
    };
...
module.exports = __webpack_require__(/*! D:\dev\recipebook\recipebook-client\src\main.ts */"./src/main.ts");
